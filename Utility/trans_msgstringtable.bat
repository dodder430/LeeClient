...
del RagexeClient\2016-02-03\Basic\data\msgstringtable.txt
...
copy RagexeClient\2016-02-03\Basic\data\msgstringtable_original.txt RagexeClient\2016-02-03\Basic\data\msgstringtable.txt
